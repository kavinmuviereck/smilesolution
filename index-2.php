			...
			<div class="container inner-content">
				<div class="row align-items-center">
					<div class="col-lg-7 col-md-6 col-sm-7">
						...
						<a href="about-us.php" class="btn btn-secondary btn-lg shadow">Read More</a>
					</div>
			...
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-lg-6 mb-30">
						...
						<a href="about-us.php" class="btn btn-primary shadow">Read More</a>
					</div>
				</div>
			</div>
				...
				<div class="row justify-content-center">
					<div class="col-lg-4 col-sm-6 mb-30">
						<div class="work-bx">
							...
							<a href="booking.php" class="btn btn-primary light">View More <i class="btn-icon-bx fas fa-chevron-right"></i></a>
						</div>
					</div>
					<div class="col-lg-4 col-sm-6 mb-30">
						<div class="work-bx active">
							...
							<a href="services.php" class="btn btn-primary light">View More <i class="btn-icon-bx fas fa-chevron-right"></i></a>
						</div>
					</div>
					<div class="col-lg-4 col-sm-6 mb-30">
						<div class="work-bx">
							...
							<a href="contact-us.php" class="btn btn-primary light">View More <i class="btn-icon-bx fas fa-chevron-right"></i></a>
						</div>
					</div>
				</div>
			</div>
		...
		<section class="section-area section-sp1 service-wraper">
			<div class="row align-items-center">
				<div class="col-xl-4 col-lg-7 mb-30">	
					...
					<a href="services.php" class="btn btn-secondary btn-lg shadow">All Services</a>
				</div>
							...
							<div class="swiper-slide">
								<div class="feature-container feature-bx2 feature1">
									...
									<div class="icon-content">
										...
										<a href="service-detail.php" class="btn btn-primary light">View More</a>
									</div>
								</div>
							</div>
							<div class="swiper-slide">
