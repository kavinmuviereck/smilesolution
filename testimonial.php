...
<div class="sub-banner-section-test">



<!-- SUB BANNER SECTION -->   
<section class="banner-section-test mt-5" >
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-md-12 col-sm-12">
				<h1 data-aos="fade-up"  class="firsttxt mt-5 mb-5"><br>CLIENT TESTIMONIALS</h1>
...
<div class="row">
	...
	// $info= $db->getRows("select * from testimonails order by s_no desc ");
	$info= $db->getRows("SELECT * FROM testimonails ORDER BY s_no DESC");
	// print_r($info);exit;
	?> 
	<div class="col-md-12">
			...
			<?php
			foreach($info as $client_data) { 
                
                ?>

				<?php
				$image = str_replace("../","",($client_data["image"]));?>

		
			<div class="testimonial">

				<h3 class="title"><?= ($client_data["name"]) ?>
				</h3>
				<div>
					

				<img src= <?= $image ?>  style=" width:100%; height:100%; " class="text-center">
				</div>
			...
			{ ?>
				<div class="col-12">
				<h3 class="text-center text-dark mt-5" >No Testimonials Found</h3>
				</div>
