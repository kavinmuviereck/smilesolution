...
<head>
	<title>Mastering Heart Health | DrDCR - Top ICD Implant Doctor Chennai</title>
					...
					<div class="page-banner-entry text-center">
						...
						<nav aria-label="breadcrumb" class="breadcrumb-row">
							<ul class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">ICD Implantation</li>
							</ul>
						</nav>
					</div>
				</div>
			...
			<div class="container speciality-container">
				...
				<div class="row align-items-center">
					...
					<div class="col-lg-5 mb-10 text-center text-lg-left">
						<div class="paroller">
							<img src="new-images/icdimplantation1.jpg" alt="ICD Implantation" class="shadows-box">
						</div>
					</div>
					
					<div class="col-lg-7 mb-10">
						<div class="heading-bx">
							<p class="text-justify">An implantable cardioverter-defibrillator (ICD) is a device that is implanted under the skin of the chest to monitor the heart's rhythm. If the heart rhythm becomes too fast or too slow, the ICD sends out electrical signals in the form of shocks, that help bring the rhythm back to normal, thus saving one’s life.</p>
							<p class="text-justify">ICDs are typically recommended for people who are at high risk of sudden cardiac arrest (SCA), a life-threatening condition that occurs when the heart suddenly stops beating. Also people with a history of cardiac arrest, heart diseases and those who have undergone certain procedure are at increased risk of sudden cardiac arrest.</p>
						</div>
					</div>
				...
				<div class="row align-items-center">
					...
					<div class="col-lg-7 mb-10">
						<div class="heading-bx">
							<p class="text-justify">The decision to implant this life-saving ICD is made on an individual basis and involves a careful assessment of the person's specific condition and risk factors. Understandably, patients and their families may be nervous or anxious about having an ICD implanted. Single chamber and dual chamber ICD implant requires a colossal amount expertise so that the procedure is performed without any complications and infections.</p>
						</div>
					</div>

					<div class="col-lg-5 mb-10 text-center text-lg-right order-first order-lg-last">
						<div class="paroller">
							<img src="new-images/icdimplantation2.jpg" alt="Ventricular tachycardia" class="shadows-box">
						</div>
					</div>
				...
				<div class="row align-items-center">
					...
					<div class="col-lg-5 mb-10 text-center text-lg-left">
						<div class="paroller">
							<img src="new-images/icdimplantation3.jpg" alt="Ventricular Fibrillation" class="shadows-box">
						</div>
					</div>

					<div class="col-lg-7 mb-10">
						<div class="heading-bx">
							<p class="text-justify">A top cardiologist in Chennai having extensive expertise in using and implanting ICDs, Dr. DCR works personally with every patient - weighing the potential benefits and risks of the procedure, and then makes a recommendation based on individual needs. His ICD device clinic is one of the very few in the country equipped with “Remote Monitoring” of devices. Please refer to the videos (link) to learn more about the complex ICDs implanted and patient education on ICDs given by Dr. DCR. Schedule an appointment with the cardiology specialist– Dr. DCR today and get the best care of your heart.</p>
						</div>
					</div>
