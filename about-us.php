		...
		<section class="section-sp1 about-area">
			<div class="container speciality-container">
				...
				<div class="row align-items-center">
					...
					<div class="col-lg-7 ">
						<div class="heading-bx">
						    <h6 class="title-ext text-secondary">Dr. Poornima Srikanth</h6>
							<h2 class="title">Cosmetic/Aesthetic Dentist, Dental Surgeon, Oral Pathologist</h2>
							<p class="text-justify"> Dr. Poornima Srikanth is a Cosmetic/Aesthetic Dentist,Dental Surgeon and Oral Pathologist in Chrompet, Chennai and has an experience of 18 years in these fields. Dr. Poornima Srikanth practices at Smile Solutions Family Dentistry in Chromepet, Chennai and Smile Solutions Family Dentistry inThoraipakkam, Chennai. She completed BDS from Ragas Dental College Hospital in 2005 and MDS- Oral Pathology from Balaji Dental College in 2011.</p>
						</div>
					</div>

					<div class="col-lg-5 mb-30 text-center text-lg-right order-first order-lg-last">
						<div class="paroller">
							<img src="images/index/poornima.jpg" alt="DrDCR – Heart Specialist Chennai" class="shadows-box">
						</div>
					</div>
