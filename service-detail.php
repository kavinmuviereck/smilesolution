				...
				<div class="row">
					<div class="col-lg-8 mb-30">
						<div class="ttr-media mb-30">
							<img src="images/services/pic1.jpg" class="rounded" alt="">
						</div>
						<div class="clearfix">
						...
						<aside class="sticky-top pb-1">
							<div class="widget">
								<ul class="service-menu">
									<li class="active"><a href="service-detail.php"><span>Engine Diagnostics</span><i class="fa fa-angle-right"></i> </a></li>
									<li><a href="service-detail.php"><span>Lube Oil and Filters</span><i class="fa fa-angle-right"></i></a></li>
									<li><a href="service-detail.php"><span>Belts and Hoses</span><i class="fa fa-angle-right"></i></a></li>
									<li><a href="service-detail.php"><span>Air Conditioning</span><i class="fa fa-angle-right"></i></a></li>
									<li><a href="service-detail.php"><span>Brake Repair</span><i class="fa fa-angle-right"></i></a></li>
									<li><a href="service-detail.php"><span>Tire and Wheel Services</span><i class="fa fa-angle-right"></i></a></li>
								</ul>
							</div>
							<div class="widget">
