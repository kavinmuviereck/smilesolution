...

{
...

	{
...

		{
			...
			die("Database Connection Failed : ".mysqli_error($this->dbCon));
...

		{
			...
			if(!$db_select) { die("Database Select Failed : ".mysqli_error($this->dbCon)); }
		}
...

	{
...

		{
			...
			$this->setErMsg(mysqli_errno($this->dbCon));
