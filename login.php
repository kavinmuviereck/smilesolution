...
<!-- Mirrored from meditro.themetrades.com/html/demo/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Mar 2023 07:27:31 GMT -->
<head>
						...
						<div class="tab-content" id="myTabContent">
							<div class="tab-pane fade show active" id="formLogin" role="tabpanel" aria-labelledby="formLogin">
								<form action="#">
									...
									<div class="form-group">
										<button type="button" class="btn mb-30 btn-lg btn-primary w-100">login</button>
							...
							<div class="tab-pane fade" id="formRegister" role="tabpanel" aria-labelledby="formRegister">
								<div class="tab-pane fade show active" id="register-home" role="tabpanel" aria-labelledby="register-home">
									<form action="#">
										...
										<div class="form-group">
											<button type="button" class="btn btn-primary w-100 radius-xl">Register Now</button>
										</div>													
										<div class="text-center mt-40">						
