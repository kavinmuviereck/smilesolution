...
if (isset($_POST['update'])) {
    ...
    $rest   = $db->updateAry("invited_faculty", $random, "WHERE id='" . $_POST['tableid'] . "'");
        ...
        if (isset($_FILES['imagefiles']['name'][$i]) && $_FILES['imagefiles']['name'][$i] != '' && !empty($_FILES['imagefiles']['name'][$i])) {
            ...
            if (in_array($ext, array('jpeg','jpg','gif','png'))) {
                ...
                if (move_uploaded_file($_FILES['imagefiles']['tmp_name'][$i], '../images/services/' . $newfile)) {
                    ...
                    $rests = $db->insertAry('invited_faculty', $imgs);
                }
            } else {
                $stat["error"] = "Please Select valid file";
            }
            ...
            <div class="container-fluid pdt-20">
                ...
                <div class="row panel panel-default mgt-20">
                    <div class="panel-heading">
                        <h1 class="white-text page-heading text-center">invited_faculty</h1>
                    </div>
                            ...
                            <div id="content" class="panel panel-default custom-panel" style="display: none;">
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 mgt-20">
                                            <label>Short Description<span class="redstar">*</span></label>
                                            <!-- <textarea name="short_description" class="form-control" placeholder="description" required=""></textarea> -->
                                            <textarea name="short_description" class="form-control editor" id="editor" placeholder="description" required="" maxlength="250"></textarea>

                                        </div>

                                        <div class="col-md-4 mgt-20">
                                            <!-- <label>Image<span class="redstar"></span></label> -->
                                            <!-- <input type="file" accept="image/png, image/jpeg, image/gif" name="imagefiles[]" id="imagefiles" required="" /> -->
                                ...
                                <div class="panel-body">
                                    <table width="100%" class="table table-bordered table-striped table-hover" id="dataTables-example-des-des">
                                        ...
                                        <tbody>
                                            <?php
                                            $counter = 0;
                                            $clients = $db->getRows("SELECT * from invited_faculty order by id desc");
                                            if (count($clients) > 0) {
                                            ...
                                            ?>
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="text-center ac_projects_delete">
                                                            <button type="button" id="delete" onclick="DeleteConfirmation(this,'invited_faculty')" name="delete" value="<?= $id ?>" class="btn btn-danger btn-circle"><i class="fa fa-times"></i>
                                                            </button>
                                                        </td>
                                                    </tr>
                                    ...
                                    Okay: {
                                        ...
                                        action: function() {
                                            $.ajax({
                                                type: 'post',
                                                url: 'ajax.php',
                                                data: 'action=delete_invited&Id=' + id + '&TableName=' + tablename,
                                                dataType: "json",
