...
<!--------------------->
  ...
  <div id="wrapper" style="background-color: #1f2278;">
      ...
      <div id="page-wrapper">
        ...
        <div class="row panel panel-default mgt-20"  >
          ...
          <div class="panel-heading">
            ...
            <h1 class="white-text page-heading">Contacted Persons</h1>
                    ...
                    <table width="100%" class="table table-bordered table-striped table-hover" id="dataTables-example">
                      ...
                      <tbody>
                        ...
                        <?php
                              ...
                              $reviews = $db->getRows("SELECT * from contact order by id desc");
                              ...
                              if( count($reviews) > 0){
                                ...
                                foreach($reviews as $data){ 
                                  ...
                                  $converted_date = date("d/m/Y", strtotime($created_date));
                              ...
                              <tr class="odd gradeX">
                                ...
                                <td><?php echo $message ?></td>
                                 ...
                                 <td class="text-center ac_projects_delete">
                                  ...
                                  <button type="button" id="delete" onclick="DeleteConfirmation(this,'contact')" name="delete" value="<?php  echo $id ?>" class="btn btn-danger btn-circle"><i class="fa fa-times"></i>
...
//                     data: 'action=delete_contact&Id='+id+'&TableName='+tablename,
            ...
            Okay: {
              ...
              action: function(){
                ...
                $.ajax({
                  ...
                  data: 'action=deletecontact&Id='+id+'&TableName='+tablename,
