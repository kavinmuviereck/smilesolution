...
$rest = $db->insertAry('speciality_gallery',$categories);
          }
        ...
        if(isset($_FILES['video']['name'][$i]))
        {
          ...
          $maxsizevideo="104857600"; 
          if (in_array($ext, array('mp4', 'avi', 'mkv'))) {
  
              $newfile = md5($_FILES['video']['tmp_name'][$i]) . "." . $ext;

              if(($_FILES['video']['size'][$i] >= $maxsizevideo)) 
              {
                // echo 1; exit;
                // echo "<script>alert('Maximum Image Size Is 3mb');</script>" ;
                $_SESSION['error'] = "Maximum Video Size Is 100mb"; 
                redirect('service-gallery.php');
              }
...
$rest = $db->insertAry('speciality_gallery',$categories);
    ...
    if (isset($_POST['update'])) {
       ...
       $edit = $db->getRow("select image, video from speciality_gallery where id = '".$_POST['tableid']."'");
      ...
      if ($_FILES['image']['name'] != '') {
       ...
       $maxibytes="3145728";
        ...
        if (in_array($ext, array('jpeg', 'jpg', 'gif', 'png','webp'))) {
            ...
            if(($_FILES['image']['size'] >= $maximumbytes)) 
            {
              // echo 1; exit;
              // echo "<script>alert('Maximum Image Size Is 3mb');</script>" ;
              $_SESSION['error'] = "Maximum Image Size Is 3mb"; 
        ...
        $rest = $db->updateAry('speciality_gallery',$categories,"where id='".$_POST["tableid"]."'");
            ...
            <div id="content" class="panel panel-default">
              ...
              <div class="panel-body">   
                  ...
                  <div>
                      ...
                      <select name="category_type" id="type" onchange="changeFileUpload()">
                  ...
                  <div class="col-md-4 mgt-20">
                    ...
                    <div id="video-division" name="type"  style="display: none;">

                      <label>Video<span style="color: red;">* ( NOTE: upload a video below 15mb Only MP4, AVI AND MKV Formats Are allowed)</span></label>
                      <!-- <input onclick="document.getElementById('video').disabled = false; document.getElementById('video_url').disabled = true;"   checked="checked" type="file" accept="video/mp4, video/avi, video/mkv" multiple="" id="video" name="video[]" placeholder="Icon" class="form-control"> -->
                      <input checked="checked" type="file" accept="video/mp4, video/avi, video/mkv" multiple="" id="video" name="video[]" placeholder="Icon" class="form-control">
                      <br><br>
                      </div>

                      <div id="video-url-division" name="type"  style="display: none;">
                      <label>Video URL</label>
                      
                      <!-- <input  onclick="document.getElementById('video').disabled = true; document.getElementById('video_url').disabled = false;"   type="text" id="video_url" name="video_url" class="form-control" disabled="disabled"> -->
                    ...
                    <table width="100%" class="table table-bordered table-striped table-hover" id="dataTables-example">
                      ...
                      <tbody>
                        ...
                        <?php
                              ...
                              $courses = $db->getRows("SELECT * from speciality_gallery ORDER by id desc");
                              ...
                              <?php  } ?>
                                ...
                                <td class="text-center ac_course_delete">
                                  ...
                                  <button type="button" id="delet" onclick="deleteConfirmation(this,'speciality_gallery')" name="delet" value="<?php  echo $album_id; ?>" class="btn btn-danger btn-circle"><i class="fa fa-times"></i>
...
//     }
        ...
        function changeFileUpload()
        {
           ...
           if(selectedType == 'image')
           {
              ...
              document.getElementById('video-url-division').style.display = 'none';
           }
           else if(selectedType == 'video')
           {
            ...
            document.getElementById('video-division').style.display = 'none';
              document.getElementById('image-division').style.display = 'none';
              document.getElementById('video-url-division').style.display = 'block';
           }
        }
    </script>
 ...
 $("#content").toggle();
  ...
  $(document).on("click",".btnCategoryEdit",function( event ) {
      ...
      $.ajax({
        ...
        data: 'action=edit_speciality_galleryimage&Id='+value,
              ...
              Okay: {
                ...
                action: function(){
                  ...
                  $.ajax({
                    ...
                    data: 'action=del_speciality_gallery&Id='+id+'&TableName='+tablename,
